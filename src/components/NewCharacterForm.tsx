...
type FormDataType = NewCharacterSchemaType;

const NewCharacterForm = () => {
  const router = useRouter();
  const { register, handleSubmit } = useForm<FormDataType>({ defaultValues });
  const { mutate, error } = trpc.useMutation(['character.createNew'], {
    onSuccess: ({ id }) => {
